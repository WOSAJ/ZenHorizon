package com.wosaj.zenhorizon.item.curio;

import com.mojang.blaze3d.matrix.MatrixStack;
import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.wosaj.zenhorizon.model.curio.StandardCurioModel;
...
public abstract class StandardCurio extends Item implements ICurioItem {
    private final StandardCurioModel model = new StandardCurioModel();
